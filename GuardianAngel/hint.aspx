<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hint.aspx.cs" Inherits="GuardianAngel.hint" %>
           ...
           <div class="auto-style2">
			&nbsp;<div class="coming-soon-subscribe container">
                <div class="row">
                         ...
                         <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="請選擇被照護人"></asp:Label>
    ...
    <!--主頁內容-->
        ...
        <tr>
            <td class="text-center">&nbsp;
                ...
                <br />
                 <asp:Button ID="btnAdd" runat="server" BackColor="#336699" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium" ForeColor="#CCFFFF" Height="30px" OnClick="btnAdd_Click" Text="選擇" Width="80px"  />
