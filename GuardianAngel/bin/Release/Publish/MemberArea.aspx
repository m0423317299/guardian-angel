              ...
              <div class="row">
                <div class="" style="margin: 0px auto;">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="fname" type="text" placeholder="Your New First Name *" required="required" data-validation-required-message="Please enter your name.">
                    <p class="help-block text-danger"></p>
                  </div>-->
                  <!--名字-->
                  <div class="form-group0" style="margin-top: -20px;">
                  ...
                  <!--姓氏
                  <div class="form-group">
                    <h3 class="section-r7style text-muted">Last Name：</h3>
                    <input class="form-control" id="lname" type="text" placeholder="Your New Last Name *" required="required" data-validation-required-message="Please enter your name.">
                    <p class="help-block text-danger"></p>
                  </div>-->
                  <!--信箱(帳號)-->
                  <div class="form-group">
