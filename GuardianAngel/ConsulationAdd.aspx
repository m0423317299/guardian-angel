<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulationAdd.aspx.cs" Inherits="GuardianAngel.ConsulationAdd" %>
...
<body style="background-image:url(/assets/img/background/careTransparent.jpg); background-size: cover;">
    ...
    <p>&nbsp;</p>
    <p class="text-center">
        <span class="fontSet"><b><strong>新增回診資料</strong></b></span></p>
    ...
    <!--主頁內容-->
          ...
          <td class="text-center">
            ...
            <span class="auto-style31">
                ...
                <table class="tableFont">
                    <tr>
                        <td class="tableTitleFont">診所名</td>
                        <td class="tableCFont">
                            <asp:TextBox ID="tbxClinic" runat="server" Width="90%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableTitleFont">診所地址</td>
                        <td class="tableCFont">
                            <asp:TextBox ID="tbxAddress" runat="server" Width="90%"></asp:TextBox>
                        </td>
                    </tr>
                   
                    <tr>
                        <td class="tableTitleFont">回診日期</td>
                        <td class="tableCFont">
                     ...
                     <tr>
                        <td class="tableTitleFont">診所電話</td>
                        <td class="tableCFont">
                    ...
                    <tr>
                       <td class="tableTitleFont">被照護者姓名</td>
                        <td class="tableCFont">
                            <asp:DropDownList ID="DropDownList1" runat="server"            AutoPostBack="True" AppendDataBoundItems="True" Font-Size="X-Large" > 
        ...
        <tr>
            <td class="text-center">
                <br />
                <asp:Button ID="btnOK" runat="server" class="btnFont" Height="50px" Width="100px" OnClick="btnOK_Click" Text="新增"/> 
                　<asp:Button ID="btnNext" runat="server" class="btnFont" Height="50px" Width="164px" OnClick="btnNext_Click" Text="再新增一筆"/>
                　<asp:Button ID="btnCancel" runat="server" class="btnFont" Height="50px" Width="100px" OnClick="btnCancel_Click" Text="取消"/>
                　<asp:Button ID="btnBack" runat="server" class="btnFont" Height="50px" Width="208px" OnClick="btnBack_Click" Text="返回資料頁"/>
