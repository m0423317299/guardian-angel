<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulationEdit.aspx.cs" Inherits="GuardianAngel.ConsulationEdit" %>
...
<body style="background-image:url(/assets/img/background/careTransparent.jpg); background-size: cover;">
    ...
    <!--主頁內容-->
        ...
        <tr>
            <td class="text-center">
                <br />
                <asp:Button ID="btnSave" runat="server" class="btnFont" Height="50px" Width="100px"  Text="儲存" OnClick="btnSave_Click"/> 
                　
                　<asp:Button ID="btnBack" runat="server" class="btnFont" Height="50px" Width="208px"  Text="返回資料頁" OnClick="btnBack_Click"/>
