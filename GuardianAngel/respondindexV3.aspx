...
<body style="background-image:url(/assets/img/background/careTransparent.jpg); background-size: cover;">
    ...
    <!-- 導覽列結束 end Navbar -->
        ...
        <p>&nbsp;</p>
    <p class="text-center">
        <span class="fontSet"><b><strong>全部異常事件列表</strong></b></span></p>
			...
			&nbsp;<div class="coming-soon-subscribe container">
                <div class="row">
                        ...
                        <asp:ListItem>請選擇被照護人</asp:ListItem>
                         ...
                         <asp:DropDownList ID="DropDownList2" runat="server"            AutoPostBack="True" AppendDataBoundItems="True" Font-Size="X-Large" onselectedindexchanged="DropDownList2_SelectedIndexChanged"> 
                        <asp:ListItem>請選擇事件類型</asp:ListItem>
                         </asp:DropDownList>        
                                 
                         <asp:DropDownList ID="DropDownList3" runat="server"            AutoPostBack="True" AppendDataBoundItems="True" Font-Size="X-Large" onselectedindexchanged="DropDownList3_SelectedIndexChanged"> 
                        <asp:ListItem Value="0">請選擇時間期限</asp:ListItem>
    ...
    <!--主頁內容-->
        ...
        <tr>
            <td class="text-center">&nbsp;<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <br />
                <asp:Button ID="Button1" runat="server" BackColor="#336699" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium" ForeColor="#CCFFFF" Height="30px" OnClick="Button1_Click" Text="回全列表" Width="80px" />
